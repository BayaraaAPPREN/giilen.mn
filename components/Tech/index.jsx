...
const Main = () => {
  return (
    <div id='service' className='bg-back1 bg-cover bg-center xs:h-screen'>
          ...
          <div className='mx-8 xs:py-20 md:py-40 '>
            ...
            <div className='xs:mx-4 sm:mx-2 md:mx-2 lg:mx-20'>
              ...
              <div className='mt-6'>
                ...
                <div className='my-8'>
                  <a className='text-slate-200 bg-[#913BFF] rounded-lg py-4 px-8 uppercase cursor-pointer hover:bg-[#DF7200]/60 transition ease-linear hover:text-slate-400'>ашигладаг технологи</a>
                </div>
              </div>
            </div>
          </div>
